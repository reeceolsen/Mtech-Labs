...
//}
//print("The value of foo is \(foo)")
// foo is put inside a for loop and outside of the curly braces does not exist
...
//because x is declared outside of the function
...
greeting(greeting: "Hi ", name: "bob")
greeting(greeting: nil, name: "billy")
