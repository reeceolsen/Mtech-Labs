 ...
 */
var walkingChallenges : [String] = ["Walk 10000 steps today", "Walk 3 miles today"]
var runningChallenges : [String] = ["Go on a run today", "Run 1 mile"]
...
if userChallenges.isEmpty {
    print("You have not selected a challenge")
}
